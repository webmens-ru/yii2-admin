...
//            'filterModel' => $searchModel,
                'columns' => [
                    ...
                    [
                        ...
                        'buttons' => [
//                        'update' => function ($url, $formFieldsModel, $key) use($form_id) {
//                            if ($formFieldsModel->iform_id != 0) {
//                                return Html::a('', ['settings/form-fields/update', 'id' => $key], ['class' => 'glyphicon glyphicon-pencil']);
//                            }
//                        },
