...
<div class="chatbot-view">
    ...
    <div class="chatbot-command-index">
        ...
        <p>
            <?= Html::a(
                'Создать',
                ['settings/chatbot/chatbot-command/create', 'chatbotCode' => $model->code],
                ['class' => 'btn btn-success']
            ) ?>
        </p>
                    ...
                    'buttons' => [
                        'update' => function ($url, $model, $key) {
                            return Html::a(
                                '',
                                [
                                    'settings/chatbot/chatbot-command/update',
                                    'bot_code' => $model->bot_code,
                        ...
                        'view' => function ($url, $model, $key) {
                            return Html::a(
                                '',
                                [
                                    'settings/chatbot/chatbot-command/view',
                                    'bot_code' => $model->bot_code,
                                    'command' => $model->command
                                ],
                                ['class' => 'fas fa-eye']
                        ...
                        'delete' => function ($url, $model, $key) {
                            return Html::a(
                                '',
                                [
                                    'settings/chatbot/chatbot-command/delete',
                                    'bot_code' => $model->bot_code,
                                    'command' => $model->command
                                ],
                                [
    ...
    <div class="app-index">
        ...
        <p>
            <?= Html::a(
                'Создать JS приложение',
                ['settings/chatbot/app/create', 'chatbotCode' => $model->code, 'type' => 'js'],
                ['class' => 'btn btn-success']
            ) ?>
            <?= Html::a(
                'Создать Ifarame приложение',
                ['settings/chatbot/app/create', 'chatbotCode' => $model->code, 'type' => 'iframe'],
                ['class' => 'btn btn-success']
            ) ?>
        </p>
