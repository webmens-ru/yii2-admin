...
$this->params['breadcrumbs'][] = ['label' => $model->name, 'url' => ['settings/robots/robots-options/view', 'property_name' => $model->property_name, 'robot_code' => $model->robot_code, 'value' => $model->value]];
