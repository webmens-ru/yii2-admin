...
<div class="robots-options-view">
    ...
    <p>
        <?= Html::a('Изменить', ['update', 'property_name' => $model->property_name, 'robot_code' => $model->robot_code, 'value' => $model->value], ['class' => 'btn btn-primary']) ?>
        <?=
        Html::a('Удалить', ['delete', 'property_name' => $model->property_name, 'robot_code' => $model->robot_code, 'value' => $model->value], [
