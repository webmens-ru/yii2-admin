...
namespace wm\admin\controllers\settings;

use Yii;
use wm\admin\models\settings\Agents;
use wm\admin\models\settings\AgentsSearch;
 ...
 */
class AgentsController extends \wm\admin\controllers\BaseModuleController
{
    /**
     * {@inheritdoc}
     */
