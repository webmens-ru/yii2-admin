...
namespace wm\admin\models\gii\model;
...
class Generator extends \yii\gii\Generator
{
     ...
     * @var string
     */
    public $baseClass = 'wm\yii\db\ActiveRecord';
     ...
     * @var string
     */
    public $queryBaseClass = 'wm\yii\db\ActiveQuery';
    ...
    {
        return 'Этот генератор создает класс ActiveRecord для указанной таблицы базы данных.';
    }
    ...
    public function hints()
    {
        return array_merge(parent::hints(), [
            'ns' => 'Это пространство имен создаваемого класса ActiveRecord, например, <code>app\models</code>',
            ...
            'queryBaseClass' => 'Это базовый класс нового класса ActiveQuery. Это должно быть полное имя класса в пространстве имен.',
            'crud' => 'Нужно ли генерировать CRUD данные в модели',
            'crudController' => 'Укажите путь к контроллеру вида <code>my-site</code> для контроллер <code>app/controllers/MySiteController</code> соответственно',
        ]);
    }
