 ...
 *
 */
class CompanySynchronizationDeltaJob extends BaseObject implements \yii\queue\JobInterface
{
    /**
     * @var string
     */
    ...
    {
        $answerB24 = Events::getOffline('onCrmCompanyAdd');
    ...
    {
        $answerB24 = Events::getOffline('onCrmCompanyUpdate');
        $eventsB24 = ArrayHelper::getValue($answerB24, 'result.events');
        $arrayId = ArrayHelper::getColumn($eventsB24, 'EVENT_DATA.FIELDS.ID');
        if ($arrayId) {
            $B24List = $this->getB24List($arrayId);
    ...
    {
        $answerB24 = Events::getOffline('onCrmCompanyDelete');
        $eventsB24 = ArrayHelper::getValue($answerB24, 'result.events');
        $arrayId = ArrayHelper::getColumn($eventsB24, 'EVENT_DATA.FIELDS.ID');
        if ($arrayId) {
